...
//        IAbstractInterval<T> leftBoundedInterval => leftBoundedInterval.Canonicalize<T, L>(step),
...
//        IAbstractInterval<DateTime> leftBoundedInterval => leftBoundedInterval.Canonicalize<L>(step),
...
//        IAbstractInterval<DateTimeOffset> leftBoundedInterval => leftBoundedInterval.Canonicalize<L>(step),
...
//         IAbstractInterval<DateOnly> leftBoundedInterval => leftBoundedInterval.Canonicalize<L>(step),
...
//        IAbstractInterval<TimeOnly> leftBoundedInterval => leftBoundedInterval.Canonicalize<L>(step),
