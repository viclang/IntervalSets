...
//    public static TypedLeftBoundedInterval<T, L> Canonicalize<T, L>(this IAbstractInterval<T> value, T? step = null)
...
//    /// <returns>The canonicalized interval in the desired interval type.</returns>
//    public static TypedLeftBoundedInterval<DateTime, L> Canonicalize<L>(this IAbstractInterval<DateTime> source, TimeSpan? step = null)
//        where L : struct, IBound
//    {
...
//    /// <param name="step">The step value used to increment or decrement the interval bounds. Defaults to 1 second.</param>
//    /// <returns>The canonicalized interval in the desired interval type.</returns>
//    public static TypedLeftBoundedInterval<DateTimeOffset, L> Canonicalize<L>(this IAbstractInterval<DateTimeOffset> source, TimeSpan? step = null)
//        where L : struct, IBound
//    {
//        step ??= TimeSpan.FromSeconds(1);
...
//    /// <returns>The canonicalized interval in the desired interval type.</returns>
//    public static TypedLeftBoundedInterval<DateOnly, L> Canonicalize<L>(this IAbstractInterval<DateOnly> source, int step = 1)
//        where L : struct, IBound
//    {
...
//    /// <param name="step">The step value used to increment or decrement the interval bounds. Defaults to 1 second.</param>
//    /// <returns>The canonicalized interval in the desired interval type.</returns>
//    public static TypedLeftBoundedInterval<TimeOnly, L> Canonicalize<L>(this IAbstractInterval<TimeOnly> source, TimeSpan? step = null)
//        where L : struct, IBound
//    {
//        step ??= TimeSpan.FromSeconds(1);
...
//    private static TypedLeftBoundedInterval<T, L> ToOpen<T, L>(IAbstractInterval<T> value, Func<T, T> substract)
//        where T : notnull, IComparable<T>, ISpanParsable<T>
//        where L : struct, IBound
//    {
