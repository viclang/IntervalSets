...
namespace IntervalRecord
{
    public static partial class Interval
    {
        public static Interval<DateTime> Canonicalize(this Interval<DateTime> value, BoundaryType boundaryType, TimeSpan step)
            => new DateTimeInterval(value).Canonicalize(boundaryType, step);
        public static Interval<DateTime> Closure(this Interval<DateTime> value, TimeSpan step)
            => new DateTimeInterval(value).Closure(step);
        public static Interval<DateTime> Interior(this Interval<DateTime> value, TimeSpan step)
            => new DateTimeInterval(value).Interior(step);
        
        public static Infinity<TimeSpan> Length(this Interval<DateTime> value, TimeSpan closureStep)
            => new DateTimeInterval(value, closureStep).Length();
        public static TimeSpan? Radius(this Interval<DateTime> value, TimeSpan closureStep)
            => new DateTimeInterval(value, closureStep).Radius();
        public static DateTime? Centre(this Interval<DateTime> value, TimeSpan closureStep)
            => new DateTimeInterval(value, closureStep).Centre();
