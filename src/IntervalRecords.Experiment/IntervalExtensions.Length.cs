...
//    private static Endpoint<TResult> Length<T, TResult>(Interval<T> source, Func<T, T, TResult> length)
//        where T : struct, IEquatable<T>, IComparable<T>, ISpanParsable<T>
//        where TResult : struct, IEquatable<TResult>, IComparable<TResult>, ISpanParsable<TResult>
//    {
//        if (source.State is not IntervalState.Bounded)
//        {
//            return Endpoint<TResult>.PositiveInfinity;
//        }
//        if (source.IsEmpty)
//        {
//            return default(TResult);
//        }
//        return length(source.End.Point, source.Start.Point);
//    }
//}
