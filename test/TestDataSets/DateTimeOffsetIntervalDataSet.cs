...
{
    public class DateTimeOffsetIntervalDataSet : IntervalTestDataSet<DateTimeOffset>
    {
        public DateTimeOffsetIntervalDataSet(Interval<DateTimeOffset> reference, TimeSpan offset)
            : base(reference)
        {
